...
<title>MacroPad · Stereo display</title>
<style>
...
<header><h1>MACROPAD</h1><div>Stereo / OLED study 01</div></header>
...
<div class="receiver"><div class="engraved"><span>SPECTRUM ANALYZER</span><span>50 Hz — 16 kHz</span></div>
<div class="glass"><canvas id="oled" width="128" height="64" role="img" aria-label="Animated preview of the MacroPad OLED spectrum and song readout"></canvas></div>
