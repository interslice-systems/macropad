...
from . import hyprland, ledtest, lofi, media, spectrum, tmux, volume
...
class Supervisor:
    def __init__(self, cfg):
        ...
        self.ctx_items = []
        self.ctx_msg = None
        # The knob: turn = output volume, push = Lofi Girl on/off.
        self.lofi = lofi.Client()
        self.volume = volume.Knob()
